...
export default class D3Radar extends Component {
    ...
    componentDidMount() {
        ...
        const data = [
            {className: "一班", chinese: 82, math: 93, physics: 88, chemistry: 95, english: 89},
            {className: "二班", chinese: 78, math: 88, physics: 77, chemistry: 92, english: 90},
            {className: "三班", chinese: 68, math: 77, physics: 76, chemistry: 62, english: 70},
            {className: "四班", chinese: 75, math: 66, physics: 69, chemistry: 88, english: 95},
        ]
